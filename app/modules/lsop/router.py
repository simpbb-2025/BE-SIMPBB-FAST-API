...
from app.modules.lsop import schemas
from app.modules.lsop.models import LampiranSpop

router = APIRouter(prefix="/lsop", tags=["lsop"])
...
def _to_record(row: LampiranSpop) -> schemas.LampiranRecord:
    return schemas.LampiranRecord(
        ...
        formulir_sesuai_ketentuan=row.formulir_sesuai_ketentuan,
    )
